          ...
          <div className="container mx-auto px-4 py-8 lg:py-20">
            <div className="mx-auto flex max-w-3xl flex-col items-center space-y-6 text-center">
              <p className="text-sm font-semibold uppercase tracking-wide text-blue-600">
                For Pakistani freelancers tired of being ignored on Upwork
              </p>
              <h1 className="text-3xl font-bold leading-tight text-gray-900 lg:text-5xl">
                Stop Sending Proposals Into the Void.
                <br />
                <span className="text-orange-500">Start Winning Upwork Clients.</span>
              </h1>
              <p className="text-lg leading-relaxed text-gray-600 lg:text-xl">
                A focused 4-week system to build a profile that converts and
                proposals that get replies — so you land your first{' '}
                <span className="font-bold text-gray-900">$1,000+ client</span>{' '}
...
export default HeroSectionUpwork;
