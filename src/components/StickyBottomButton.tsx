...
const StickyBottomButton = () => {
  ...
  return (
    <div>
      {/* Floating WhatsApp button - always visible on all screens */}
      <div className="floating-whatsapp ">
        <button
          onClick={handleWhatsAppClick}
          className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-110 animate-pulse"
        >
          <svg 
            viewBox="0 0 24 24" 
            fill="currentColor" 
