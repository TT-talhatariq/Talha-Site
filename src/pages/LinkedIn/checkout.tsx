...
export default function CheckoutLinkedIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/thank-you-linkedin');
    } catch (error) {
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="text-blue-600">Opportunity Engine</span> Today!
            </h1>
            <p className="text-lg text-gray-600">
              Build a profile that turns views into DMs — and a content rhythm that
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-white/50 shadow-xl sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between">
                    <span className="text-gray-600">LinkedIn Mastery</span>
