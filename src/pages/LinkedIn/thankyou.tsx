...
export default function ThankYouLinkedIn() {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
              Congratulations on taking the first step towards a LinkedIn that works for you!
              We&apos;re thrilled to have you on board for the <span className="text-orange-500 font-semibold">LinkedIn Mastery</span> course.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
            ...
            <button
              onClick={() => {
                ...
                const message = "Hi Talha! I just enrolled in the LinkedIn Mastery course and need help with access.";
