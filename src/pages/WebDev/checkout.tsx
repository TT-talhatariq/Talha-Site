...
export default function CheckoutWebDev() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      setErrors(prev => ([ ...prev, 'Payment screenshot is required' ]));
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50/30 to-orange-100/50 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="max-[1440px] mx-auto">
          {/* Back Link */}
          <div className="mb-6">
            <Link href="/web-dev" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium transition-colors">
              ← Back to Main Page
            </Link>
          </div>
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Complete Your <span className="text-blue-600">Web Development</span> Enrollment
            </h1>
            <p className="text-lg text-gray-600">
              You&apos;re just one step away from mastering web development and earning 500k+ monthly!
            </p>
          </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-white/50 shadow-xl sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between text-green-600">
                    <span>Discount (93% OFF)</span>
                    <span>-PKR 46,500</span>
                  </div>
                  <hr className="border-gray-200" />
                  <div className="flex justify-between text-xl font-bold">
                    <span>Total</span>
                    <span className="text-blue-600">PKR 3,500</span>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 mb-6">
                      <h4 className="text-lg font-bold text-green-900 mb-4">📱 E-Mobile Accounts</h4>
                      <div className="space-y-4 text-gray-800">
                        <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50"
                  >
