        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Start Your{' '}
              <span className="text-blue-600">Global Remote Career</span> Today!
            </h1>
            <p className="text-lg text-gray-600">
              Transform your life and earn $1500-$5000 USD monthly working from
              anywhere! 🌍
            </p>
          </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-white/50 shadow-xl sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between text-blue-600">
                    ...
                    <span>-PKR 46,003</span>
                  </div>
                  <hr className="border-gray-200" />
                  <div className="flex justify-between text-xl font-bold">
                    <span>Total</span>
                    <span className="text-blue-600">PKR 3,997</span>
                  </div>
                </div>
              </div>
            </div>
