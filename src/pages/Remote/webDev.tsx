  ...
  return (
    <div>
      ...
      <Bonuses
        ...
        sectionSubtitle="Here's what you get, and what it would cost you separately. Total standalone value: PKR 59,000. Your price today: PKR 3,987 (founding members; price increases as enrollment grows)."
      />
      <RemoteInstructorBioSection />
