...
export default function CheckoutUpwork() {
  ...
  const validateForm = () => {
    ...
    if (!formData.whatsapp.trim())
      newErrors.push('WhatsApp number is required');
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Start Winning <span className="text-blue-600">Upwork Clients</span>{' '}
              Today!
            </h1>
            <p className="text-lg text-gray-600">
              Build a profile that converts and proposals that get replies — land
              your first $1,000+ client. 💼
            </p>
          </div>
