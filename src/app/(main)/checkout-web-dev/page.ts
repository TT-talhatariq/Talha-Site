...
export const metadata: Metadata = {
    ...
    description: "Secure checkout for Web Development Masterclass. Get instant access to 15+ projects, 9 proven earning methods, and start your journey to PKR 500k+ monthly earnings. 92% discount - limited time offer!",
    ...
    openGraph: {
        ...
        description: "Secure checkout for Web Development Masterclass. Get instant access to 15+ projects and 9 proven earning methods. 92% discount - limited time!",
        type: "website",
        locale: "en_US",
