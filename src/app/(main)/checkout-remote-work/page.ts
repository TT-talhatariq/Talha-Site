...
export const metadata: Metadata = {
    ...
    description: "Secure checkout for Remote Work Mastery course. Get instant access to LinkedIn hacks, Upwork secrets, and global job hunting strategies. Start earning in USD from Pakistan. 91% discount - limited time offer!",
    ...
    openGraph: {
        ...
        description: "Secure checkout for Remote Work Mastery course. Get instant access to global job hunting strategies and start earning in USD. 91% discount - limited time!",
        type: "website",
        locale: "en_US",
