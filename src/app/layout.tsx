      ...
      <head>
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=792263316561861&ev=PageView&noscript=1"
            alt=""
          />
          <img
            height="1"
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1507662913842457&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      </head>
