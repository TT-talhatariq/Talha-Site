          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8 max-w-[1440px] mx-auto">
            {courses.map((course) => (
              ...
              >
                ...
                <div
                  className={`absolute -top-10 -right-10 w-40 h-40 ${course.badgeColor} opacity-10 rounded-full blur-3xl animate-pulse`}
                ></div>
                <div
                  className={`absolute -bottom-10 -left-10 w-32 h-32 ${course.badgeColor} opacity-5 rounded-full blur-2xl animate-pulse animation-delay-2000`}
                ></div>
                  ...
                  <div className="space-y-4">
                        ...
                        {course.features.length > 4 && (
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-orange-700 font-semibold">
                              + {course.features.length - 4} more game-changing
                              strategies!
                            </span>
                          </div>
                        )}
                    ...
                    <div className="space-y-3">
                      ...
                      <Link href={course.link}>
                        <button
                          className={`w-full ${course.badgeColor} hover:opacity-90 text-white font-bold py-4 px-6 rounded-2xl transition-opacity duration-200 shadow-lg`}
                        >
                          🚀 START EARNING NOW
                        </button>
                      </Link>
            ...
            <div className="bg-gradient-to-br from-white via-blue-50/40 to-orange-50/30 rounded-3xl p-8 lg:p-12 shadow-xl border border-white/50 backdrop-blur-sm">
              <div className="text-center space-y-6">
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">
                  Need{' '}
                  <span className="text-blue-600">Personalized Guidance</span>?
                </h2>
                <p className="text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto">
                  Book a 1-on-1 consultation with Talha. Get personalized help
                  with remote work, freelancing, LinkedIn optimization, resume
                  review, or career strategy.
                </p>
